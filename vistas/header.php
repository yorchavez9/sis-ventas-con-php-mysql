...
<head>
  ...
  <link rel="shortcut icon" href="../public/img/logo/logo-min.png">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  ...
                  <div class="text-center">
                    <b><a href="../ajax/usuario.php?op=salir" class="btn" style="background: #FF4D4D; color: white;">Salir</a></b>
                  </div>
                </li>
              </ul>
            </li>
        ...
        <ul class="sidebar-menu">
          ...
          <li>
            <a href="#">
              ...
              <small class="label pull-right bg-green">PDF</small>
            </a>
          </li>
          <li>
            <a href="#">
